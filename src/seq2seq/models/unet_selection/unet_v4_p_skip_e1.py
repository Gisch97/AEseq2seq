...
from .conv_layers import conv3_ap as conv
from .conv_layers import tconv3_ap as tconv
...
class Seq2Seq(nn.Module):
    ...
    def build_graph(
        ...
        **kwargs
        ...
        self.encode1_out=filters
   
        # Decoder
        self.decode1_in = self.encode1_out  
        self.decode1_out = self.encode1_in  
        
        self.L_min = 128 // ((2**num_conv1))
        self.latent_dim=64
        ...
        self.architecture = {
            ...
            "arc_latent_volume": self.L_min * self.encode1_out,
            "arc_kernel": kernel,
